...
I'm an **AI/ML Engineer** with 4+ years of experience spanning full-stack software development, production AI/ML systems, and applied research. I specialize in building end-to-end GenAI solutions — **RAG pipelines**, **multi-agent systems**, **computer vision models**, and **LLM-powered applications** that ship to production and serve real users.

I believe in the path from **idea → MVP → production**. Every project I work on is built with deployment in mind.

---

## 👨‍🎓 About Me

🔭 I hold a **Master of Science in Computer Science** from [**Southern Illinois University Carbondale**](https://www.siu.edu/) and a **B.Tech in Computer Science and Engineering** from [**St. Martin's Engineering College**](https://www.smec.ac.in/), Hyderabad.

🔭 I have hands-on experience building and deploying **multi-agent AI systems**, **RAG pipelines**, **computer vision models**, and **full-stack web applications** in production environments.

🔭 Below are some of the companies and institutions I have worked at:

   * *KKR GenAI Innovations LLC*
   * *Southern Illinois University Carbondale — AI Labs*
...
[![](https://img.shields.io/badge/LangGraph-1C3C3C?style=for-the-badge&logoColor=white)](https://langchain-ai.github.io/langgraph/)
[![](https://img.shields.io/badge/OpenAI-412991?style=for-the-badge&logo=openai&logoColor=white)](https://openai.com/)
[![](https://img.shields.io/badge/Anthropic-191919?style=for-the-badge&logo=anthropic&logoColor=white)](https://www.anthropic.com/)
...
[![](https://img.shields.io/badge/LoRA-FF6F00?style=for-the-badge&logoColor=white)](https://arxiv.org/abs/2106.09685)
...
[![](https://img.shields.io/badge/Pinecone-000000?style=for-the-badge&logoColor=white)](https://www.pinecone.io/)
...
[![](https://img.shields.io/badge/Matplotlib-11557C?style=for-the-badge&logoColor=white)](https://matplotlib.org/)
...
I encourage you to explore my AI/ML and software engineering projects. The links are provided below along with detailed descriptions in each repository.

---

## 🖥 My Computer Vision Projects

| 🫁 [Pneumonia Detection Using CNN & VGG16](https://github.com/CHANx0000/Pneumonia-Detection-CNN-VGG16) |
| --- |
| Built and compared a custom CNN (90.76% accuracy) and VGG16 transfer learning model (95.03% accuracy) to classify chest X-ray images as Normal or Pneumonia. Evaluated using precision, recall, F1-score, and confusion matrices on the Kaggle Chest X-Ray dataset. |
...
## 🖥 My Education
   ...
   🏫 [**Southern Illinois University Carbondale**](https://www.siu.edu/) — *Master of Science in Computer Science* *[January 2024 – December 2025]*

   🏫 [**St. Martin's Engineering College**](https://www.smec.ac.in/) — *Bachelor of Technology, Computer Science and Engineering* *[August 2018 – August 2022]*

---

## 🖥 My Certifications

   🌱 **100xEngineers GenAI Bootcamp** — Advanced training in production GenAI systems, LLM applications, and AI engineering best practices.
